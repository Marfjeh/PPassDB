                    ...
                    <div class="card-body">
                        <form method="POST" action="{{url('accounts', [$account->id])}}">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-md-6">
                                    <input id="name" type="text" class="form-control{{ $errors->has('name') ? ' is-invalid' : '' }}" name="name" value="{{ $account->name }}" required autofocus>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-md-6">
                                    <input id="url" type="text" class="form-control{{ $errors->has('url') ? ' is-invalid' : '' }}" name="url" value="{{ $account->url }}" required autofocus>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-md-6">
                                    <input id="password" type="password" class="form-control{{ $errors->has('password') ? ' is-invalid' : '' }}" name="password" value="{{ $account->password }}" required autofocus>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-md-6">
                                    <input id="WriteGroup" type="text" class="form-control{{ $errors->has('WriteGroup') ? ' is-invalid' : '' }}" name="WriteGroup" value="{{ $account->WriteGroup }}" required autofocus>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-md-6">
                                    <input id="ReadGroup" type="text" class="form-control{{ $errors->has('ReadGroup') ? ' is-invalid' : '' }}" name="ReadGroup" value="{{ $account->ReadGroup }}" required autofocus>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-md-6">
                                    <input id="Tag" type="text" class="form-control{{ $errors->has('Tag') ? ' is-invalid' : '' }}" name="Tag" value="{{ $account->Tag }}" required autofocus>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-md-6">
                                    <textarea id="Description" name="Description" class="form-control">{{$account->Description}}</textarea>
                                </div>
                            </div>
